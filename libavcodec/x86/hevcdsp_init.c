...
void ff_hevc_dsp_init_x86(HEVCDSPContext *c, const int bit_depth)
{
    ...
    if (bit_depth == 8) {
        ...
        if (EXTERNAL_SSE2(cpu_flags)) {
            ...
            c->transform_add[0] = ff_hevc_transform_4x4_add_10_sse2;
            c->transform_add[1] = ff_hevc_transform_8x8_add_10_sse2;
            c->transform_add[2] = ff_hevc_transform_16x16_add_10_sse2;
            c->transform_add[3] = ff_hevc_transform_32x32_add_10_sse2;
        }
        if (EXTERNAL_SSSE3(cpu_flags) && ARCH_X86_64) {
        ...
        if (EXTERNAL_SSE2(cpu_flags)) {
            ...
            c->transform_add[0] = ff_hevc_transform_4x4_add_12_sse2;
            c->transform_add[1] = ff_hevc_transform_8x8_add_12_sse2;
            c->transform_add[2] = ff_hevc_transform_16x16_add_12_sse2;
            c->transform_add[3] = ff_hevc_transform_32x32_add_12_sse2;
        }
        if (EXTERNAL_SSSE3(cpu_flags) && ARCH_X86_64) {
